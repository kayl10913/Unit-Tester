		...
		<div className="card hover-card mb-8">
			<div className="flex items-start justify-between mb-6">
				<div className="flex items-start space-x-3">
					...
					<div>
						<h2 className="text-xl font-semibold text-gray-100">What is Unit Testing Generator?</h2>
						...
						<div className="flex flex-wrap items-center gap-3 mt-4">
							<span className="inline-flex items-center px-3 py-1 text-xs rounded-full bg-green-500/10 text-green-300 border border-green-500/20">
								<Lightbulb size={14} className="mr-2" />
								Boost confidence
							</span>
							<span className="inline-flex items-center px-3 py-1 text-xs rounded-full bg-purple-500/10 text-purple-300 border border-purple-500/20">
								<Sparkles size={14} className="mr-2" />
								AI suggestions
							</span>
							<span className="inline-flex items-center px-3 py-1 text-xs rounded-full bg-blue-500/10 text-blue-300 border border-blue-500/20">
			...
			<div className="border border-gray-600/50 rounded-xl overflow-hidden">
				<div className="bg-gray-800/50 px-6 py-4 border-b border-gray-600/50 flex items-center justify-between">
				...
				<div className="p-6 space-y-6">
					<div className="grid grid-cols-1 lg:grid-cols-3 gap-4">
						...
						<div className="flex flex-col gap-3">
							<button
								...
								className="btn-primary btn-hover-effect flex items-center justify-center space-x-2"
							>
								<Sparkles size={18} />
							...
							<div className="flex flex-wrap gap-2">
								{exampleQuestions.map((q, i) => (
									<button
										...
										className="px-3 py-1 rounded-lg text-xs bg-gray-700/50 border border-gray-600/50 text-gray-300 hover:bg-gray-700 transition"
									>
										{q}
									</button>
								))}
					...
					{answer && !isLoading && (
						<div className="mt-2 bg-gray-800/50 border border-gray-600/50 rounded-xl p-5">
